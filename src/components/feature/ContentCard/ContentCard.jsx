  ...
  return (
    <div className="contentCard">
      ...
      <div className="header">
        <img src={temp.company_logo} />
        <div className="title">
          <span className="name">{temp.company}</span>
          <span className="createdAt">{temp.created_at}</span>
        </div>
      </div>
      {/* Image Section */}
      ...
      <div className="detailContainer">
        <div className="detail">
          ...
          <span className="label">{temp.title}</span>
        </div>
        <div className="detail">
          <span><EnvironmentFilled /> </span>
          <span className="label">{temp.location}</span>
        </div>
        <div className="detail">
          <span><SoundFilled /> </span>
          <span className="label">{temp.type}</span>
        </div>
      </div>
    </div>
  );
